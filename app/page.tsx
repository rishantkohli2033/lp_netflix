  ...
  return (
    <div className="bg-gradient-to-b from-red-900 via-black to-black min-h-screen flex flex-col items-center justify-center text-white">
      ...
      <main className="flex flex-col items-center justify-center w-full px-4 text-center">
        ...
        {/* Steps Box */}
        <div className=" text-white rounded-lg p-6 shadow-md max-w-lg">
        ...
        {/* Apply Button */}
        <button className="mt-8 bg-red-600 text-white py-3 px-8 rounded-full text-lg md:text-xl font-semibold hover:bg-red-700">
          APPLY NOW
        </button>
      </main>
